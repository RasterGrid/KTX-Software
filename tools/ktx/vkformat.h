...
[[nodiscard]] inline std::string toStringVkFormat(VkFormat format) noexcept {
    ...
    return str != "VK_UNKNOWN_FORMAT" ? str : fmt::format("(0x{:X})", static_cast<int64_t>(format));
}
...
[[nodiscard]] constexpr inline bool isFormatStencil(VkFormat format) noexcept {
    ...
    case VK_FORMAT_D32_SFLOAT_S8_UINT: // [[fallthrough]];
        return true;
    default:
        return false;
    }
...
[[nodiscard]] constexpr inline bool isFormatBlockCompressed(VkFormat format) noexcept {
    ...
    case VK_FORMAT_ASTC_6x6x6_SFLOAT_BLOCK_EXT: // [[fallthrough]];
        return true;
    default:
        return false;
    }
...
[[nodiscard]] constexpr inline bool isFormat3DBlockCompressed(VkFormat format) noexcept {
    // TODO Tools P4: List block compressed formats with block depth greater than 1. Is there any?
    (void) format;
    return false;
}
